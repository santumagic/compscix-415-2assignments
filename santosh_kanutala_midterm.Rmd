...
**Answer:**  
   ...
   2. There is no clear comparision visible between the age groups and with in the genders becase it shows the individual   elemennts are compared against the responses only.  
...
table2
# It is not tidy, so below code makes it tidy
