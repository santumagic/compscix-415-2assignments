...
In the above code we are trying to map the three aesthetics x, y, color to three variables of the dataset. But for the third aesthtic is assigned as a text "blue" which is invalid.
