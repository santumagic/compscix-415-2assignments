...
## <u>Exercise 2</u>
### Question: 1
```{r Ex_2_Q1, message=FALSE, warning=FALSE}
```
### Question: 2
```{r Ex_2_Q2, message=FALSE, warning=FALSE}
```
### Question: 3
```{r Ex_2_Q3, message=FALSE, warning=FALSE}
```
### Question: 4
```{r Ex_2_Q4, message=FALSE, warning=FALSE}
```
### Question: 5
```{r Ex_2_Q5, message=FALSE, warning=FALSE}
```
### Question: 6
```{r Ex_2_Q6, message=FALSE, warning=FALSE}
```
### Question: 7
